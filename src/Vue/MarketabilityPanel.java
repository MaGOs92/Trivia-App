...
public class MarketabilityPanel extends JDialog implements ActionListener {
	...
	public MarketabilityPanel(Colonne[] colonnes){
		
		boite = Box.createVerticalBox();
 		setModal(true);
 		setTitle("Marketability graph.");
 		...
 		titre.add(new JLabel("Select the field which will be included in the Marketability graph."));			
